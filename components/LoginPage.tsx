      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-lg rounded-2xl border border-zinc-800 p-8 shadow-2xl">
          ...
          <div className="mt-6 pt-6 border-t border-zinc-800/50">
            <div className="bg-emerald-500/5 backdrop-blur-sm border border-emerald-500/10 rounded-xl px-4 py-3 flex items-start gap-3">
              <Lock size={16} className="text-emerald-400 mt-0.5 shrink-0" aria-hidden="true" />
              <div>
                <p className="text-[11px] text-emerald-400/80 font-medium tracking-wide uppercase mb-1">Protected access</p>
